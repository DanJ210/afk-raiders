...
export const TIME_OF_DAY_PROFILES: Record<TimeOfDay, TimeOfDayProfile> = {
  ...
  Night: {
    ...
    robotEncounterWeightMultiplier: 1.2,
    robotFailureDamageMultiplier: 1.15,
    extractionRiskEventWeightMultiplier: 1.25,
    extractionSafeEventWeightMultiplier: 0.95,
  },
  'Stella Red': {
    ...
    robotEncounterWeightMultiplier: 1.5,
    robotFailureDamageMultiplier: 1.35,
    extractionRiskEventWeightMultiplier: 1.6,
    extractionSafeEventWeightMultiplier: 0.75,
  },
}
