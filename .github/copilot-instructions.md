...
### Raid Pacing
Raid aggression is autonomous; there is no extraction preference slider. The greed system is currently disabled, so greed no longer drives extract/downed decisions during RAIDING. Raiders now keep raiding until they die, the raid timer expires, or CALL_EXTRACT is used.
